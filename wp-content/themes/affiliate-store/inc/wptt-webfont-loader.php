...
if ( ! class_exists( 'Affiliate_Store_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Affiliate_Store_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$affiliate_store_contents = wp_remote_retrieve_body( $response );

			return $affiliate_store_contents;
		}
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Affiliate_Store_WPTT_WebFont_Loader( $url );
